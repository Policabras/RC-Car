...
static const uint8_t TCA_CHANNEL = 0;    // canal del TCA donde está el PCA9685
...
// ==============================
// Este rango ya no es en microsegundos teóricos.
// Son cuentas del PCA9685 calibradas con lo que sí te funcionó.
// Ajusta si quieres más recorrido, pero empieza con esto.
...
void loop() {
  ...
  if (readPacket(newV, newW, newF, newBase, newElbow, newWrist, newGrip)) {
    // Mantengo tu corrección original de motores
